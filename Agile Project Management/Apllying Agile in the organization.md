...
* **Definition of Value:** Value is defined as what provides benefits to users, which can include financial gains, user engagement, or compliance.
* **The Goal:** The Agile principle emphasizes satisfying customers by delivering valuable products quickly and efficiently.

### The "Build and Run" Framework
To deliver value, teams must focus on three specific areas:
1.  **Building the Right Thing:** Engaging in solution-oriented conversations with customers to understand their needs and goals.
2.  **Building the Thing Right:** Focusing on necessary features to avoid complexity and potential issues.
3.  **Running it Right:** Planning for ongoing support and user interactions after delivery to maintain value over time.

---

## 2. The Value Roadmap

A value roadmap is a strategic tool used to map out product ideas and delivery strategies.

### Key Components
| Component | Definition | Responsibility |
| :--- | :--- | :--- |
| **Product Vision** | Defines what the product is and who uses it. It acts as the guiding principle. | The Team |
| **Product Roadmap** | A high-level overview of requirements and milestones to ensure the team builds the right product. | Product Owner |
| **Release Plans** | Outlines expected release dates and feature goals. These are "living documents" flexible to adjustments. | Product Owner & Project Manager |
