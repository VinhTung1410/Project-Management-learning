...
```mermaid
graph LR
    Proposal[Project Proposal] --> Charter[Project Charter]
```
...
```mermaid
graph TD
    Failure --> Budget[Budget Gaps]
    Failure --> People[Unavailable Skills]
    Failure --> Docs[Poor Documentation]
    Failure --> Tools[Wrong Tools]
    Failure --> Scope[Uncontrolled Scope]
```
### Preventable Causes
